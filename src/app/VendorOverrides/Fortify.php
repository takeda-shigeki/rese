...
namespace App\VendorOverrides;

use Laravel\Fortify\Contracts\ConfirmPasswordViewResponse;
use Laravel\Fortify\Contracts\CreatesNewUsers;
use Laravel\Fortify\Contracts\LoginViewResponse;
use Laravel\Fortify\Contracts\RegisterViewResponse;
use App\Http\Responses\ThanksViewResponse;//追加
...
use App\Http\Responses\SimpleThanksViewResponse;//追加
...
class Fortify
{
    ...
    public static function viewPrefix(string $prefix)
    {
        ...
        static::thanksView($prefix.'thanks');//追記
    ...
    //以下追記
    public static function thanksView($view)
    {
        app()->singleton(ThanksViewResponse::class, function () use ($view) {
            return new SimpleThanksViewResponse($view);
        });
    }
